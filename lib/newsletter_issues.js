...
// Owner manual add: create (or re-confirm) an ACTIVE, confirmed subscriber.
// Reuses normalizeEmail. NEVER reactivates a suppressed (bounced/complained)
// row — that honors a hard opt-out and protects sender reputation. A brand-new
// address is inserted active/source='manual'; a pending or previously
// unsubscribed row is (re)activated by this explicit owner action; an already
// active address is a no-op. Returns { subscriber, result }.
