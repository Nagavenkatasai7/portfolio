...
// URLs (canonical, Open Graph, sitemap).
//
...
// system vars, then localhost. Where a Request is available (e.g. the newsletter
// preview route) the caller can derive the exact origin the browser used instead
// — see originFromHeaders.
// ============================================================
